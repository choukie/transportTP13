...
<head>
    <meta charset="UTF-8">
    <title>Erreur serveur - TransitPro</title>
...
<div style="min-height:100vh;display:flex;align-items:center;justify-content:center;background:#f0f2f8;">
    <div style="text-align:center;padding:60px;">
        ...
        <h1 style="font-size:80px;font-weight:900;color:var(--danger);margin:0;">500</h1>
        <h2 style="font-size:24px;color:var(--primary);margin:10px 0;">Erreur interne du serveur</h2>
